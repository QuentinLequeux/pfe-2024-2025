        ...
        <div className={'flex flex-wrap gap-8 m-2 justify-center h-fit'}>
            {animals.data.map((animal:IAnimal) => (
                <Link href={route('animals.show', { id: animal.id })} key={animal.id} className={'h-auto w-[250px] rounded-lg shadow-lg dark:bg-[#1c1e21]'}>
                    ...
                    <div className={'bg-main m-auto mb-2 flex w-[80%] justify-center rounded-md p-1 text-black'}>
                        <svg
                            className={'mr-2'}
                    ...
                    <div className={'bg-main m-auto mb-4 flex w-[80%] justify-center rounded-md p-1 text-black'}>
                        <svg className={'mr-2'} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path
